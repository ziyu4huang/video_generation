---
name: playwright-cli
description: Use when automating browser interactions, driving web UIs for testing or scraping, or authoring and debugging Playwright tests via playwright-cli (run through bunx).

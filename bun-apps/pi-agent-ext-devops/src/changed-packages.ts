 ...
 *    package that transitively depends on it: if `pi-agent-ext-file2md` changes,
 *    `pi-agent-ext-flux2` (direct dep) AND `pi-agent-ext-movie-director`
 ...
 */
const MATRIX_IRRELEVANT_PREFIXES = [".planning/", "bun-apps/tests/", "dsh-sv-analyzer/"];

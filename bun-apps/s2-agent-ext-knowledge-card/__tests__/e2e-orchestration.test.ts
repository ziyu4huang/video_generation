 ...
 * tools write/read there instead of the real s2-agent-vault.
 *
...
const _obsRealAbs = new URL(
	"../../s2-agent-ext-obsidian/src/index.ts",
	import.meta.url,
).pathname;
const _obsReal: Record<string, unknown> = await import(_obsRealAbs);

mock.module("@repo/s2-agent-ext-obsidian", () => ({
	..._obsReal,

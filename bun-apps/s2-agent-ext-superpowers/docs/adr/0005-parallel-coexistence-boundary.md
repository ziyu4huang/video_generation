**ID:** `ADR-superpowers-0005` — ADR numbers restart per context, so this number alone is ambiguous; cite this ID. Index: repo-root `CONTEXT-MAP.md`
...
verbatim bodies". See
`.planning/2026-07-21-review-bun-apps-s2-agent-ext-superpowers-see-if-/tickets/02,03,04.md`

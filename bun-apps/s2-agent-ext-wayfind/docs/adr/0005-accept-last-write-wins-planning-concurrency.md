**ID:** `ADR-wayfind-0005` — ADR numbers restart per context, so this number alone is ambiguous; cite this ID. Index: repo-root `CONTEXT-MAP.md`

# ADR-0005: Accept last-write-wins for `.planning/<effort>/` concurrency

Date: 2026-07-27
Status: accepted
See: [superpowers ADR-0005](../../../s2-agent-ext-superpowers/docs/adr/0005-parallel-coexistence-boundary.md) (the shared-layout contract), [ADR-0004](./0004-decouple-status-widget-via-global.md)

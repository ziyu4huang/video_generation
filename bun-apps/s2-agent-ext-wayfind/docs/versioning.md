...
|---|---|---|
| `@repo/s2-agent-ext-wayfind` | `0.1.0` | Pi-native port of Matt Pocock's decision-chain skill suite (grilling / wayfinder / domain-modeling). |
| `@repo/s2-agent-ext-superpowers` | `6.1.1` | Pi-native port of Superpowers (Primer Radiant) — tracks the upstream's v6.x line. |

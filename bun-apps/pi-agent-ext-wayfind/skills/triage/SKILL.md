---
name: triage
description: Use when issues or external PRs pile up on the project tracker — moves them through a state machine of triage roles (categorise, verify, grill if needed) and writes agent-ready briefs.

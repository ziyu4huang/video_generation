---
name: wizard
description: Use when a manual procedure needs a human in the loop — provisioning infra, credentials, CI secrets, or an unfamiliar third-party dashboard. Generates a bash wizard that walks them through each step; skip steps the agent can do itself.
---

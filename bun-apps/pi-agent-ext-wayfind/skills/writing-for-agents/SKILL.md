...
description: Use when creating or editing a skill, an AGENTS.md, or any doc an agent consumes — the craft reference for context pointers, information hierarchy, progressive disclosure, leading words, and pruning.
---

/**
 * Coordination seam — wayfind ⇄ plan coordinator.
 *
 * Mirrors the goal side's coordination seam.
 *
 ...
 * package is NOT guaranteed — the plan coordinator's published singleton might be a
...
/** Publish the "is a wayfind session active" reader so the plan coordinator can

 ...
 * Output is task_plan-shaped: a Goal line, a glossary block, and a phased
 * breakdown. The user executes this plan.
 *
 * Two regimes:
...
export function buildPlanSeed(decisions: ResolvedDecision[], glossary: GlossaryTerm[], topic?: string): string | null {
  ...
  lines.push("");
  lines.push("> Generated by `/grill done --seed-plan`. Review/expand the phases, then execute the plan.");

 ...
 * `bun-apps/pi-agent-ext-wayfind/skills/grill-memory/SKILL.md`, but that file
 * does NOT exist — `grill-memory` is packaged in the **hermes-memory**
 * extension (`bun-apps/pi-agent-ext-hermes-memory/skills/grill-memory/`), not
...
const HERMES_SKILLS = join(import.meta.dir, "..", "..", "pi-agent-ext-hermes-memory", "skills");

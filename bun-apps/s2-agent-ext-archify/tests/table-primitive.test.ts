...
import { PALETTES, type TypeSpec } from "../src/deck-theme.ts";
import { emitHtmlSlide, type EmitHtmlCtx } from "../src/emit-html.ts";
import { emitPptxSlide, type EmitPptxCtx } from "../src/emit-pptx.ts";
import { lintPptx, formatDiagnostics } from "../src/ooxml-lint.ts";
import { countSlides } from "../src/deck-render.ts";
import { readZipText } from "../src/read-zip.ts";
import { formatBlocks, type PlacedBlock } from "../src/slide-model.ts";

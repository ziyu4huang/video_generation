...
import { addShapeIrToSlide, labelWidthEms, type Box } from "../src/pptx-shapes.ts";
import { textEms } from "../src/text-extent.ts";
import { spySlide, type SpyCall } from "./helpers/spy-slide.ts";
import type { ShapeIR, ShapeNode, Style } from "../src/shape-ir.ts";

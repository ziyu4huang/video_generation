 ...
 *      `__tests__/fixtures/templates/<name>.txt`, exactly like the
...
import { emitPptxSlide } from "../lib/emit-pptx.ts";
import { PALETTES } from "../lib/deck-theme.ts";
import { formatBlocks, type LayoutCtx, type PlacedBlock, type Slide } from "../lib/slide-model.ts";

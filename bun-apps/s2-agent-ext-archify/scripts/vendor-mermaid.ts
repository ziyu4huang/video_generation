 ...
 * package's gitignored `vendored/` dir at build time.
 *
 ...
 * (`lib/architecture-render.ts`) still reads `vendored/mermaid.min.js` at render
...
const DEST = join("vendored", "mermaid.min.js");

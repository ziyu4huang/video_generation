 ...
 * s2-agent-ext-flux2/src/index.ts's shape; the two real differences are (1)
...
async function runOnce(
  ...
  // unhandled rejection (found by s2-agent-ext-ltx-self-improve's review
  // lane, 2026-07-04).
  let bin: string;
  try {
  ...
  // in invoke.ts/binary.ts (found by s2-agent-ext-ltx-self-improve's review

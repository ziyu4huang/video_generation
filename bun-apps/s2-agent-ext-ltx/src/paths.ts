 ...
 * s2-agent-ext-flux2/src/paths.ts's guarantees exactly (same threat model,
 ...
 * s2-agent-ext-flux2/src/paths.ts's assertSafePathComponent.
 */
 ...
 * s2-agent-ext-ltx-self-improve's review lane, 2026-07-05). Allowed to be
...
/** Resolve the default MLX output dir, mirroring run.py / s2-agent-ext-flux2's own resolution. */
 ...
 * s2-agent-ext-flux2's create-if-missing philosophy. Returns the resolved
 * absolute path.
 */

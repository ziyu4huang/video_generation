 ...
 * s2-agent-ext-flux2/src/commands.ts's design exactly — see that file's header
...
export interface FieldSpec {
   ...
   * missing files (see s2-agent-ext-ltx-self-improve's path-safety finding,
   * 2026-07-05).
   */
   ...
   * instead of erroring (s2-agent-ext-ltx-self-improve's review lane,

 ...
 * s2-agent-ext-flux2/extensions/flux2.ts).
 *
 ...
 *
 * Load (source mode):
 *   bun bun-apps/s2-agent/src/cli.ts -e bun-apps/s2-agent-ext-ltx/extensions/ltx.ts -p "..."
 * Bundle:
 *   bun scripts/build-bundle.ts  ->  dist/pi-extensions/s2-agent-ext-ltx.bundle.js
 *
 ...
 * s2-agent-ext-flux2/extensions/flux2.ts's coerceOptions exactly.
 */

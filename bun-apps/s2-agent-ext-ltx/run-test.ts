#!/usr/bin/env bun
/**
 * run-test.ts — tiered test launcher for s2-agent-ext-ltx.
 *
 ...
 * *
 * USAGE (from anywhere):
 *   bun bun-apps/s2-agent-ext-ltx/run-test.ts              # = quick
 *   bun bun-apps/s2-agent-ext-ltx/run-test.ts full
 *   bun bun-apps/s2-agent-ext-ltx/run-test.ts --list       # print the tier table, exit 0
 *   bun bun-apps/s2-agent-ext-ltx/run-test.ts quick --bail # extra flags are forwarded

/**
 * build-bundle.ts — bundle the s2-agent-ext-flux2 extension into one minified .js
 ...
 *
 * Output: ../../dist/pi-extensions/s2-agent-ext-flux2.bundle.js
 */
import { existsSync, mkdirSync, rmSync, writeFileSync } from "node:fs";
import { basename, resolve } from "node:path";

const APP_NAME = "s2-agent-ext-flux2";

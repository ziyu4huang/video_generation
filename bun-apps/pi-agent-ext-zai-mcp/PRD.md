...
export ZAI_API_KEY=...
pi -e bun-apps/pi-agent-ext-zai-mcp
```

## Cross-reference

- [`bun-apps/pi-agent/run-dir/manifest.json`](../pi-agent/run-dir/manifest.json) — auto-load configuration

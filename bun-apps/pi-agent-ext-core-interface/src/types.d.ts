// Types entry for `@repo/pi-agent-ext-core-interface`.
//
// WHY THIS FILE EXISTS (the packaging puzzle):
//   - `/// <reference types="@repo/pi-agent-ext-core-interface" />` resolves the
...
//   - `import { SEAM_KEYS, publishSeam, ... } from "@repo/pi-agent-ext-core-interface"`

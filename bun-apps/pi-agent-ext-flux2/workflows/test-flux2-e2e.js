// @ts-nocheck
/**
 * test-flux2-e2e.js — canonical L2 judgment e2e for pi-agent-ext-flux2.
 *
 ...
 *   manifest parse) is covered by `pi-agent-ext-flux2/src/*.test.ts`. This workflow
...
export const meta = {
  name: "test_flux2_e2e",
  description:
    "L2 judgment e2e for pi-agent-ext-flux2: generate via the flux2 CLI, then VLM-score each output (run.py caption --style score). Pass = every output clears conservative quality thresholds.",
  phases: [
    { title: "Generate" },
    { title: "Judge" },
  ],

...
combinator (`pi-dynamic-workflows/src/workflow.ts`); the validator is pure JS
...
**Tests.** `bun-apps/pi-dynamic-workflows/tests/regression-self-improve-loop.test.ts`

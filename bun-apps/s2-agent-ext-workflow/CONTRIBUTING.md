...
Thanks for contributing to s2-agent-ext-workflow. This project values small, well-tested changes that keep the workflow runtime predictable. A few conventions keep review fast.

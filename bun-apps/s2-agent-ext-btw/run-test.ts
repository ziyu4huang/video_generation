#!/usr/bin/env bun
/**
 * run-test.ts — tiered test launcher for s2-agent-ext-btw.
 *
 ...
 *   bun bun-apps/s2-agent-ext-btw/run-test.ts --list       # print the tier table, exit 0
 *   bun bun-apps/s2-agent-ext-btw/run-test.ts quick --bail # extra flags are forwarded

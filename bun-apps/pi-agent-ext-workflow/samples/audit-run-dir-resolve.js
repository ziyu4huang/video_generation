 ...
 *
 * Target: bun-apps/pi-agent/run-dir/resolve.ts — the lazy-extension alias
 ...
 *   PI_MODEL=google/gemma-4-12b-qat \
...
const TARGET = "bun-apps/pi-agent/run-dir/resolve.ts";
...
Empty array if nothing real.`,
  ...
  {
    key: "test-coverage",
    prompt: `Read ${TARGET} AND the test file bun-apps/pi-agent/run-dir/resolve.test.ts. Identify

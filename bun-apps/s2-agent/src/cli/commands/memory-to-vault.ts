...
export const memoryToVaultCommand = {
	...
	details: `Usage:
  s2-agent cli pipeline memory-to-vault [options]
...
Examples:
  s2-agent cli pipeline memory-to-vault --dry-run
  s2-agent cli pipeline memory-to-vault --concurrency 2 --retries 4
  s2-agent cli pipeline memory-to-vault --only video_generation__* --verify`,

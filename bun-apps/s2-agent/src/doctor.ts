 ...
 * and its extension set is whatever s2-agent.registry.yaml shipped. So this reads
 ...
 * for a while, `docs/deploy.md` § "The tree is read-only" — would read a clean report as

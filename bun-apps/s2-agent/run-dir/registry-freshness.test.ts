/**
 * The freshness gate: manifest.json is derived from the typed REGISTRY
 * (src/registry-config.ts, via loadRegistry — ticket 02). RED when someone
 * hand-edits the manifest OR edits the registry without running
 * `bun run regen:manifest`. This is the tripwire that makes the generated
 * file safe to keep.
 */

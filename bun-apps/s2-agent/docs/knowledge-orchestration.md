...
> retrieval-arc verdict in `bun-apps/s2-agent-ext-knowledge-card/docs/kg-improvement-plan.md` (recall is adequate;
...
./s2-agent.sh cli zk-ingest --source hermes \
...
# recall regression (the retrieval arc, see bun-apps/s2-agent-ext-knowledge-card/docs/kg-improvement-plan.md + scripts/):

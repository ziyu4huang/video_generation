# `s2-agent cli` — Knowledge-Layer Role

> The 5 `zk-*` commands (`src/cli/commands/zk-*.ts`) are **thin shells** over
> [`s2-agent-ext-knowledge-card`](../../s2-agent-ext-knowledge-card). All logic (task builders,
...
| Command | Imports from `s2-agent-ext-knowledge-card/...` | Does |
| ------- | ------------------------------------ | ---- |
...
`s2-agent-ext-knowledge-card` is a **hard `workspace:*` dep** (static import).
Renaming an exported builder/function breaks the CLI at build time — caught by
`( cd bun-apps/s2-agent && bun test )`. The retrieval-quality self-improve
workflow (`bun-apps/s2-agent/workflows/retrieval-quality-self-improve.js`)
...
See `../../s2-agent-ext-knowledge-card/docs/ARCHITECTURE.md` § "Data flow" for why the P1
callout boost is `retrieveRecords`-only.

## Cross-links

- Canonical dependency graph: [`../../s2-agent-ext-knowledge-card/docs/DEPENDENCIES.md`](../../s2-agent-ext-knowledge-card/docs/DEPENDENCIES.md)
- Architecture: [`../../s2-agent-ext-knowledge-card/docs/ARCHITECTURE.md`](../../s2-agent-ext-knowledge-card/docs/ARCHITECTURE.md)
- Data model: [`../../s2-agent-ext-knowledge-card/docs/DATA-MODEL.md`](../../s2-agent-ext-knowledge-card/docs/DATA-MODEL.md)
- PR history: [`../../s2-agent-ext-knowledge-card/docs/PR-HISTORY.md`](../../s2-agent-ext-knowledge-card/docs/PR-HISTORY.md)

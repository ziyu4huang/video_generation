...
Net effect: **~18,000 → ~10,000 tok/req (~45% saved; gross ~8,050, net ~7,900 after the `enable_tool` escape-hatch overhead)**, measured by `bun run qa:savings` (re-run for live numbers; figures drift as the gate set changes).

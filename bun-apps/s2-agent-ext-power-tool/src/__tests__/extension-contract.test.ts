 ...
 *
 * Named extension-contract (not contract.test.ts) to avoid confusion with
 * the pre-existing src/__tests__/contract.test.ts, which tests an unrelated
 * concern (schema-cost).
 */
...
describe("s2-agent-ext-power-tool extension contract", () => {

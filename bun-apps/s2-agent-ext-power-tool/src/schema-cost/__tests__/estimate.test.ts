...
// ─── Golden fixture: the same tool set the s2-agent schema-cost command ranks
...
// s2-agent heuristic, byte-for-byte, on this fixture.
...
describe("PARITY CONTRACT — submodule matches s2-agent schema-cost logic", () => {

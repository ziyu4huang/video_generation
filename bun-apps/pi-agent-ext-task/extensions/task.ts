...
/**
 * pi-agent-ext-task — the task-execution cockpit: /goal + todo + ask_user_question + shared composite status widget.
 *
 * Merged from pi-agent-ext-task (pi-core-task.ts) and

 ...
 */
export function parseToolsProbeLine(
  stderr: string,
): { ok: true; value: ToolsProbePayload } | { ok: false; message: string } {
  ...
  if (
    ...
    return {
      ok: false,
      message: "[TOOLS] payload malformed (missing total/activeCount/active/missing/getActiveTools)",
    };
  }

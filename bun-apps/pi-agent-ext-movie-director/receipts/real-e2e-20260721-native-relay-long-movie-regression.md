...
```
( cd bun-apps/pi-agent-ext-ltx && bun test )
...
sweep above (692 passing tests across pi-agent-ext-movie-director include
...
- `bun-apps/pi-agent-ext-movie-director/src/driver-wiring.ts` `produceAssets`

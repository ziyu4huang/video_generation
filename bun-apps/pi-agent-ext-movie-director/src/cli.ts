 ...
 * movie-director orchestration layer. Each of the 18 orchestration commands is
...
Usage:
  bun .../pi-agent-ext-movie-director/src/cli.ts <command> [options]
  bun .../pi-agent-ext-movie-director/src/cli.ts <command> --help   (per-command reference)

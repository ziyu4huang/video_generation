/**
 * Offline subprocess e2e harness for bun-pi-agent-cli.
 *
 * Spawns `bun src/cli.ts <args>` in the package dir with a hermetic env and
...
// _helpers.ts lives at <pkg>/src/__tests__/e2e/ → up THREE levels to pkg root.

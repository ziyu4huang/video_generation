...
// (s2-agent's schema-cost command re-exported them as a @deprecated delegate;
// that alias was removed in the gating-field migration Task 5).
import type { SchemaCostReport, ToolCost } from "@repo/s2-agent-ext-power-tool/schema-cost";

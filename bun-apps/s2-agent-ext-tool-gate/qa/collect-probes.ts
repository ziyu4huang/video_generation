 ...
 * tool-gate, a QA concern, not the shared `@repo/s2-agent-core-interface`).
...
import { __GATE_PROBES__ as flux2Probes } from "@repo/s2-agent-ext-flux2/extensions/flux2.ts";
import { __GATE_PROBES__ as ltxProbes } from "@repo/s2-agent-ext-ltx/extensions/ltx.ts";
...
import {
	...
	VERIFY_MERGE_PROBES,
	MAIN_HEALTH_PROBES,
} from "@repo/s2-agent-ext-devops/extensions/devops.ts";
import { __GATE_PROBES__ as zkProbes } from "@repo/s2-agent-ext-knowledge-card/extensions/knowledge-card.ts";
import { __GATE_PROBES__ as skillProbes } from "@repo/s2-agent-ext-hermes-memory/src/tools/skill-tool.ts";
import { __GATE_PROBES__ as knowledgeSearchProbes } from "@repo/s2-agent-ext-hermes-memory/src/tools/knowledge-search-tool.ts";
import { __GATE_PROBES__ as knowledgeIngestProbes } from "@repo/s2-agent-ext-hermes-memory/src/tools/knowledge-ingest-tool.ts";
import { __GATE_PROBES__ as webAccessProbes } from "@repo/s2-agent-ext-web-access";
import { __GATE_PROBES__ as obsidianProbes } from "@repo/s2-agent-ext-obsidian/extensions/obsidian.ts";
import { __GATE_PROBES__ as wayfindProbes } from "@repo/s2-agent-ext-wayfind/extensions/wayfind.ts";
...
import { __GATE_PROBES__ as browserProbes } from "@repo/s2-agent-ext-power-tool/src/tools/browser-tool.ts";

...
import file2mdDefault from "@repo/s2-agent-ext-file2md/extensions/file2md.ts";
import flux2Default from "@repo/s2-agent-ext-flux2/extensions/flux2.ts";
import krea2Default from "@repo/s2-agent-ext-krea2/extensions/krea2.ts";
import ltxDefault from "@repo/s2-agent-ext-ltx/extensions/ltx.ts";
import movieDefault from "@repo/s2-agent-ext-movie-director/extensions/movie-director.ts";
import researchDefault from "@repo/s2-agent-ext-research-tool/extensions/research-tool.ts";
...
import powerToolDefault from "@repo/s2-agent-ext-power-tool/extensions/power-tool.ts";
...
// ALSO registers deploy_pi_agent_sh + verify_pi_agent_deploy (absorbed from the former s2-agent-ext-
// deploy extension) — both carry owner-declared gating, so they ride via
// devopsDefault here (no separate deploy capture).
import devopsDefault from "@repo/s2-agent-ext-devops/extensions/devops.ts";
import wayfindDefault from "@repo/s2-agent-ext-wayfind/extensions/wayfind.ts";
...
import { registerServerTools } from "@repo/s2-agent-ext-zai-mcp/extensions/zai-mcp.ts";
...
import knowledgeCardDefault from "@repo/s2-agent-ext-knowledge-card/extensions/knowledge-card.ts";
import webAccessDefault from "@repo/s2-agent-ext-web-access";
import obsidianDefault from "@repo/s2-agent-ext-obsidian/extensions/obsidian.ts";
...
import { registerKnowledgeSearchTool } from "@repo/s2-agent-ext-hermes-memory/src/tools/knowledge-search-tool.ts";
import { registerKnowledgeIngestTool } from "@repo/s2-agent-ext-hermes-memory/src/tools/knowledge-ingest-tool.ts";

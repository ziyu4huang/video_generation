...
[`../../pi-agent-ext-flux2/workflows/poses.json`](../../pi-agent-ext-flux2/workflows/poses.json):
...
- Method + research: [`../../pi-agent-ext-flux2/docs/pose-validation.md`](../../pi-agent-ext-flux2/docs/pose-validation.md).

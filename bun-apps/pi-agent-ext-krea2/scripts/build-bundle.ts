/**
 * build-bundle.ts — bundle the pi-agent-ext-krea2 extension into one minified .js
 * loadable via `pi -e <bundle>.js`. Mirrors pi-agent-flux2/scripts/build-bundle.ts.
 *
 ...
 *
 * Output: ../../dist/pi-extensions/pi-agent-ext-krea2.bundle.js
 */
import { existsSync, mkdirSync, rmSync, writeFileSync } from "node:fs";
import { basename, resolve } from "node:path";

const APP_NAME = "pi-agent-ext-krea2";
const ENTRY = "extensions/pi-krea2.ts";

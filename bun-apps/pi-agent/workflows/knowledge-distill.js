...
1. Bash("OB_VAULT_PATH='${VAULT}' bun --cwd '${PROJECT_ROOT}/bun-apps/pi-agent' src/cli.ts cli zk-extract '${src}' --folder '${FOLDER}' --max-notes ${MAX_NOTES} --model lm-studio/google/gemma-4-12b --thinking ${THINKING} -p 2>&1 | tail -40")

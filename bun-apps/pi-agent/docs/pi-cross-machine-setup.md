...
### pi-agent patch toggles (build/runtime)
...
pi-agent's **run-dir** mechanism (PRs #151/#153) lets extensions load cwd-independently:
...
startup. See the "Extensions via run-dir" section of `bun-apps/pi-agent/README.md`.

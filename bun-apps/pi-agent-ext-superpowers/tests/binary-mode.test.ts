 ...
 * real skills are extracted by pi-agent's extract-embedded-assets patch to
 * $BUN_PI_EMBEDDED_EXTRACT_DIR/pi-agent-ext-superpowers/skills and passed to
...
const BUNFS_URL = "file:///$bunfs/root/pi-agent";

 ...
 * pi-agent-ext-* L2 workflows (flux2, krea2) MUST NOT silently drop either case
...
const WORKFLOWS = [
  { ext: "flux2", file: "bun-apps/pi-agent-ext-flux2/workflows/test-flux2-e2e.js" },
  { ext: "krea2", file: "bun-apps/pi-agent-ext-krea2/workflows/test-krea2-e2e.js" },
];

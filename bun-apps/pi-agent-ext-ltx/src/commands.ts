...
export const COMMANDS: Record<string, CommandSpec> = {
  ...
  "native-i2v": {
    ...
    fields: {
      ...
      rescaleScale: { flag: "--rescale-scale", type: "number", description: "Variance-preserving rescale strength applied after the CFG/STG blend (0 disables). Ignored when both CFG and STG are inactive." },

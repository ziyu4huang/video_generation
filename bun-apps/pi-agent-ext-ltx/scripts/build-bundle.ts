/**
 * build-bundle.ts — bundle the pi-agent-ext-ltx extension into one minified .js
 * loadable via `pi -e <bundle>.js`. Mirrors pi-agent-ext-flux2/scripts/build-bundle.ts.
 *
 ...
 *
 * Output: ../../dist/pi-extensions/pi-agent-ext-ltx.bundle.js
 */
import { existsSync, mkdirSync, rmSync, writeFileSync } from "node:fs";
import { basename, resolve } from "node:path";

const APP_NAME = "pi-agent-ext-ltx";
const ENTRY = "extensions/pi-ltx.ts";

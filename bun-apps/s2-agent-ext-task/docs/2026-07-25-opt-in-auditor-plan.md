...
**Goal:** Add an opt-in isolated completion auditor to `s2-agent-ext-task` so an audit-enabled goal's `goal_complete` is gated by a fresh read-only pi session's three-way verdict, closing the self-report bamboozle.
...
**Spec:** `bun-apps/s2-agent-ext-task/docs/2026-07-25-opt-in-auditor.md`
...
- **Conversation zh-TW; written artifacts English.** Run from repo root: `python/venv/bin/python …` for python, `bun` for TS. Tests: `( cd bun-apps/s2-agent-ext-task && bun test && bun run typecheck )`.
...
**Files:**
- Create: `bun-apps/s2-agent-ext-task/src/goal/shield.ts`
- Test: `bun-apps/s2-agent-ext-task/src/goal/__tests__/shield.test.ts`
...
Run: `( cd bun-apps/s2-agent-ext-task && bun test src/goal/__tests__/shield.test.ts )`
...
```bash
git add bun-apps/s2-agent-ext-task/src/goal/shield.ts bun-apps/s2-agent-ext-task/src/goal/__tests__/shield.test.ts
...
**Files:**
- Modify: `bun-apps/s2-agent-ext-task/src/goal/format.ts` (ActiveGoal interface)
- Modify: `bun-apps/s2-agent-ext-task/src/goal/state.ts` (createGoal signature)
- Test: `bun-apps/s2-agent-ext-task/src/goal/__tests__/state.test.ts` (extend the existing createGoal test)
...
Run: `( cd bun-apps/s2-agent-ext-task && bun test src/goal/__tests__/state.test.ts -t "audit options" )`
...
**Files:**
- Create: `bun-apps/s2-agent-ext-task/src/goal/auditor.ts`
- Test: `bun-apps/s2-agent-ext-task/src/goal/__tests__/auditor.test.ts`
...
Run: `( cd bun-apps/s2-agent-ext-task && bun test src/goal/__tests__/auditor.test.ts )`
...
```bash
git add bun-apps/s2-agent-ext-task/src/goal/auditor.ts bun-apps/s2-agent-ext-task/src/goal/__tests__/auditor.test.ts
...
- Test: `bun-apps/s2-agent-ext-task/src/goal/__tests__/commands.test.ts`
...
```bash
sed -n '16,100p' bun-apps/s2-agent-ext-task/src/goal/commands.ts
```
...
Run: `( cd bun-apps/s2-agent-ext-task && bun test src/goal/__tests__/commands.test.ts -t "audit flags" )`
...
- Test: `bun-apps/s2-agent-ext-task/src/goal/__tests__/hardening-loop.test.ts` (extend) OR a new `__tests__/audit-wiring.test.ts`
...
Run: `( cd bun-apps/s2-agent-ext-task && bun test src/goal/__tests__/audit-wiring.test.ts )`
...
```bash
git add bun-apps/s2-agent-ext-task/src/goal/goal.ts bun-apps/s2-agent-ext-task/src/goal/__tests__/audit-wiring.test.ts

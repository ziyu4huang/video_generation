...
**Goal:** Add a `/list` goal queue (Loop 2) to `s2-agent-ext-task` — `activeGoal`=head, `list`=tail; clean complete auto-promotes the next tail item; `/list next` losslessly parks the head at the tail + promotes; minimal 5-command surface; queue renders as a dim widget suffix only when ≥2 items exist.
...
**Spec:** `bun-apps/s2-agent-ext-task/docs/2026-07-25-list-loop-spec.md`
...
- **Conversation zh-TW; written artifacts English.** Gate: `( cd bun-apps/s2-agent-ext-task && bun test && bun run typecheck )`. Run from repo root.
...
**Files:**
- Modify: `bun-apps/s2-agent-ext-task/src/goal/format.ts`
- Modify: `bun-apps/s2-agent-ext-task/src/goal/state.ts`
- Test: `bun-apps/s2-agent-ext-task/src/goal/__tests__/state.test.ts`
...
Run: `( cd bun-apps/s2-agent-ext-task && bun test src/goal/__tests__/state.test.ts -t "list fields" )`
...
```bash
grep -rn "GoalAuditOptions" bun-apps/s2-agent-ext-task/src
```
...
Run: `( cd bun-apps/s2-agent-ext-task && bun test src/goal/__tests__/state.test.ts )`
...
Run: `( cd bun-apps/s2-agent-ext-task && bun test && bun run typecheck )`
Expected: full suite green; typecheck clean.

```bash
git add bun-apps/s2-agent-ext-task/src/goal/format.ts bun-apps/s2-agent-ext-task/src/goal/state.ts bun-apps/s2-agent-ext-task/src/goal/__tests__/state.test.ts
...
**Files:**
- Create: `bun-apps/s2-agent-ext-task/src/goal/list.ts`
- Test: `bun-apps/s2-agent-ext-task/src/goal/__tests__/list.test.ts`
...
Run: `( cd bun-apps/s2-agent-ext-task && bun test src/goal/__tests__/list.test.ts )`
...
```bash
git add bun-apps/s2-agent-ext-task/src/goal/list.ts bun-apps/s2-agent-ext-task/src/goal/__tests__/list.test.ts
...
**Files:**
- Modify: `bun-apps/s2-agent-ext-task/src/goal/persistence.ts`
- Test: `bun-apps/s2-agent-ext-task/src/goal/__tests__/persistence.test.ts` (extend existing)
...
Run: `( cd bun-apps/s2-agent-ext-task && bun test src/goal/__tests__/persistence.test.ts -t "persistGoalState|loadGoalStateFromSession" )`
...
Run: `( cd bun-apps/s2-agent-ext-task && bun test src/goal/__tests__/persistence.test.ts )`
...
```bash
git add bun-apps/s2-agent-ext-task/src/goal/persistence.ts bun-apps/s2-agent-ext-task/src/goal/__tests__/persistence.test.ts
...
**Files:**
- Modify: `bun-apps/s2-agent-ext-task/src/goal/commands.ts`
- Test: `bun-apps/s2-agent-ext-task/src/goal/__tests__/commands.test.ts` (extend)
...
Run: `( cd bun-apps/s2-agent-ext-task && bun test src/goal/__tests__/commands.test.ts -t "parseListCommand" )`
...
Run: `( cd bun-apps/s2-agent-ext-task && bun test src/goal/__tests__/commands.test.ts )`
...
```bash
git add bun-apps/s2-agent-ext-task/src/goal/commands.ts bun-apps/s2-agent-ext-task/src/goal/__tests__/commands.test.ts
...
**Files:**
- Modify: `bun-apps/s2-agent-ext-task/src/goal/goal.ts`
- Test: `bun-apps/s2-agent-ext-task/src/goal/__tests__/list-wiring.test.ts` (new)
...
```bash
grep -n "registerCommand\|parseCommand\|startGoal\|persistGoal\b\|loadGoalFromSession\|sendUserMessage\|session_start" bun-apps/s2-agent-ext-task/src/goal/goal.ts
```
...
Run: `( cd bun-apps/s2-agent-ext-task && bun test src/goal/__tests__/list-wiring.test.ts )`
...
```bash
git add bun-apps/s2-agent-ext-task/src/goal/goal.ts bun-apps/s2-agent-ext-task/src/goal/persistence.ts bun-apps/s2-agent-ext-task/src/goal/__tests__/list-wiring.test.ts
...
**Files:**
- Modify: `bun-apps/s2-agent-ext-task/src/goal/goal.ts`
- Test: `bun-apps/s2-agent-ext-task/src/goal/__tests__/list-advance.test.ts` (new)
...
Run: `( cd bun-apps/s2-agent-ext-task && bun test src/goal/__tests__/list-advance.test.ts )`
...
```bash
git add bun-apps/s2-agent-ext-task/src/goal/goal.ts bun-apps/s2-agent-ext-task/src/goal/__tests__/list-advance.test.ts
...
**Files:**
- Modify: `bun-apps/s2-agent-ext-task/src/goal/format.ts`
- Modify: `bun-apps/s2-agent-ext-task/src/goal/overlay.ts`
- Modify: `bun-apps/s2-agent-ext-task/src/goal/goal.ts` (compute + pass the queue slice)
- Test: `bun-apps/s2-agent-ext-task/src/goal/__tests__/format.test.ts` (extend)
...
Run: `( cd bun-apps/s2-agent-ext-task && bun test src/goal/__tests__/format.test.ts -t "queue suffix" )`
...
Run: `( cd bun-apps/s2-agent-ext-task && bun test src/goal/__tests__/format.test.ts )`
...
```bash
git add bun-apps/s2-agent-ext-task/src/goal/format.ts bun-apps/s2-agent-ext-task/src/goal/overlay.ts bun-apps/s2-agent-ext-task/src/goal/goal.ts bun-apps/s2-agent-ext-task/src/goal/__tests__/format.test.ts

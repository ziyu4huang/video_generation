// @ts-nocheck
/**
 * test-krea2-e2e.js — canonical L2 judgment e2e for s2-agent-ext-krea2.
 *
 ...
 *   `[krea2] saved` parse, path safety) is covered by `s2-agent-ext-krea2/src/*.test.ts`.
...
export const meta = {
  name: "test_krea2_e2e",
  description:
    "L2 judgment e2e for s2-agent-ext-krea2: generate via the krea2 CLI (native Swift Krea 2 Turbo), then VLM-score each output (run.py caption --style score). Pass = every output clears conservative quality thresholds.",
  phases: [
    { title: "Generate" },
    { title: "Judge" },
  ],
...
// complex poses — see s2-agent-ext-flux2/docs/pose-validation.md §1). When

/**
 * invoke.ts — spawn `krea2`, stream progress, honor abort.
 *
...
/** Spawn krea2 and stream until exit/abort. Never rejects — check exitCode/aborted. */
export function invokeKrea2(opts: InvokeOpts): Promise<InvokeResult> {

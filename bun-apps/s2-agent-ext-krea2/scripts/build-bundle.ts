/**
 * build-bundle.ts — bundle the s2-agent-ext-krea2 extension into one minified .js
 * loadable via `pi -e <bundle>.js`. Mirrors s2-agent-flux2/scripts/build-bundle.ts.
 *
 ...
 *
 * Output: ../../dist/pi-extensions/s2-agent-ext-krea2.bundle.js
 */
import { existsSync, mkdirSync, rmSync, writeFileSync } from "node:fs";
import { basename, resolve } from "node:path";

const APP_NAME = "s2-agent-ext-krea2";
const ENTRY = "extensions/krea2.ts";

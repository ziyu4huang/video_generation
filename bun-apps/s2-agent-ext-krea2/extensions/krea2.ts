 ...
 *
 * Load (source mode):
 *   bun bun-apps/s2-agent/src/cli.ts -e bun-apps/s2-agent-ext-krea2/extensions/krea2.ts -p "..."
 * Bundle:
 *   bun scripts/build-bundle.ts  →  dist/pi-extensions/s2-agent-ext-krea2.bundle.js
 *

...
// Load colocated per-workflow knowledge (committed .knowledge.jsonl) — UX patterns
// + avoids (e.g. recurring clarity/empty-state issues seen across runs).
...
await extractKnowledge(KB_FILE, RUN_ID, histEntry.result, null)

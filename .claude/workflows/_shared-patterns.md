...
All seven workflows own a committed `.claude/workflows/<wf>.knowledge.jsonl`,
...
2026-06-19 all seven are `load ✓ / extract ✓`.
...
- **Full mirror (shared `saveHistory`):** `gui-movie-director-review-optimize`,
  ...
  `gui-movie-director-self-improve`,
...
Five files are seeded from real history (126 records); two are 0-byte placeholders

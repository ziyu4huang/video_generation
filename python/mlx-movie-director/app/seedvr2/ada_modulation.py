...
class AdaModulation(nn.Module):
    ...
    def modulate_vid(self, hidden: mx.array, emb: mx.array, layer: str, mode: str) -> mx.array:
    ...
    def modulate_txt(self, hidden: mx.array, emb: mx.array, layer: str, mode: str) -> mx.array:

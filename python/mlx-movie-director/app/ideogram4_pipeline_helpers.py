"""Byte-exact Ideogram4 pipeline constants + build_inputs — extracted
verbatim from mlx-ideogram4/pipeline.py (lines 19-120).

These are transcription-critical: LATENT_SHIFT/LATENT_SCALE (128-dim each)
are per-channel VAE normalization constants; a single wrong float silently
breaks decode. Extracted by script (never hand-typed) and length-validated.
"""

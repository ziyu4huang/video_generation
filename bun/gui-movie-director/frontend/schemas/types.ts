export type FieldDef =
  ...
  | { type: "number"; key: string; label: string; min?: number; max?: number; step?: number; default?: number; compact?: boolean; visible?: (state: Record<string, any>) => boolean }
  ...
  | { type: "select"; key: string; label: string; options?: { value: string; label: string }[]; choicesFrom?: string; default?: string; visible?: (state: Record<string, any>) => boolean }

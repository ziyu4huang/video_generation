...
export const videoRelayCommand: UnifiedCommand = {
  ...
  fields: [
    ...
    { key: "cfg_scale", cliFlag: "--cfg-scale", control: "number", label: "CFG Scale", default: 5.0, compact: true },
    { key: "stg_scale", cliFlag: "--stg-scale", control: "number", label: "STG Scale", default: 1 },

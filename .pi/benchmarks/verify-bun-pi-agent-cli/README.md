...
> |------|---------|-----------|
> | **this dir** — `.pi/benchmarks/verify-bun-pi-agent-cli/` | pi dynamic workflow (pi-coding-agent) | `.pi/workflows/verify-bun-pi-agent-cli.js` |
...
- `stage1-seed-emnlp-893/` — committed stage1 (pdf→md) for the EMNLP fixture,
  pages 1-3. Pass `stage1From=.pi/benchmarks/verify-bun-pi-agent-cli/stage1-seed-emnlp-893`
...
bun run .pi/benchmarks/verify-bun-pi-agent-cli/compare.ts <path-to-result.jsonl>
```

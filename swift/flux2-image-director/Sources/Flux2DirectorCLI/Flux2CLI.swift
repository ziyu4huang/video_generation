...
struct Flux2CLI: ParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        version: "0.1.0",
        subcommands: [
            T2I.self, Edit.self, Angle.self, Segment.self, Models.self,
            VerifyVAE.self, VerifyEncoder.self, VerifyTokenizer.self,
            VerifyTransformer.self, VerifyE2E.self, VerifyEdit.self,
        ]
    )
}

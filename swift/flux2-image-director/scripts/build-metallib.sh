...
# the flux2 release binary so MLX can load its Metal kernels at runtime.
#
# WHY THIS EXISTS
# --------------
...
# `swift build -c release` therefore produces a flux2 binary with NO metallib,
...
#
# This is invoked automatically by bun-apps/s2-agent-ext-flux2/src/binary.ts after a

...
# executable so `swift run` / `.build/debug/embed-mlx-server` can use the GPU.
#
...
# Same pattern as swift/z-image-director, swift/krea2-image-director,
# swift/ltx-video-director, swift/flux2-image-director.
#
# Usage:

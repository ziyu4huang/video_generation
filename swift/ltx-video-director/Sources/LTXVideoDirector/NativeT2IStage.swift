...
public struct NativeT2IStage {
    ...
    public let profileAttnMlp: Bool
    public let cacheSkipStep: Int?
    ...
    public init(
        ...
        profileAttnMlp: Bool = false, cacheSkipStep: Int? = nil
    ) {
        ...
        self.profileAttnMlp = profileAttnMlp
        self.cacheSkipStep = cacheSkipStep
    }

...
- Token cost of the armed addendum is UNMEASURED until t01 lands — target ≤ ~300 tokens over the simplified set; measure in ticket and record here.
...
- `verify()` default reviewers=2 (stdlib:99-124) vs CC's "3–5 vote" phrasing — whether to raise the default or only mention it in the ladder guidance is a t01 call; record it in the ticket.

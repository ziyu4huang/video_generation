...
| 05 | v1 pilot wiring (questionnaire + archify cards) + docs/E2E | closed | questionnaire ask-cards (answers ride ask_user_answer bridge; card_done retires, Set-guarded) + archify attention-view readonly cards w/ body.url; snoop de-noised; webui 521/0 |

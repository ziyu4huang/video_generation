...
- [07 — Skill fidelity guard](tickets/07-skill-fidelity-guard.md) — RESOLVED (grilled 2026-07-20): positive content pin of all 14 upstream-ported SKILL.md (not denylist — dep-guard ADR-0001 lesson); re-sync = explicit `rebaseline-upstream-skills.ts` + `UPSTREAM.ref` provenance (no auto). Implemented + ADR-0004. Frontier now 04/05 (08 closed #724; 09 concrete-build complete #715–#719/#722).

...
- [x] 06 — Patches boilerplate: envFlag adoption ×11, patchApplied helper, footer-extension-status-notify keep/remove decision (complete 2026-08-25 branch s2-agent-simplify-t06-patches-boilerplate: isPatchDebug/isPatchOrModelsDebug/gatedPatchOutcome in index.ts — no static cycle, exact legacy semantics, one flagged "yes"-narrowing accepted; footer patch REMOVED on pinned-SDK evidence — setExtensionStatus itself requestRenders; gates 1060 pass; reviewer READY — evidence in ticket Outcome)
